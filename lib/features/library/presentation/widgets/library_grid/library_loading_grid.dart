...
class LibraryLoadingGrid extends StatefulWidget {
  const LibraryLoadingGrid({
    super.key,
  ...
  @override
  State<LibraryLoadingGrid> createState() => _LibraryLoadingGridState();
}

class _LibraryLoadingGridState extends State<LibraryLoadingGrid> {
  int _currentPage = 1;
  ...
  @override
  void didUpdateWidget(LibraryLoadingGrid oldWidget) {
