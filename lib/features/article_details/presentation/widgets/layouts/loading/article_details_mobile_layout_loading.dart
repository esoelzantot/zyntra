...
class ArticleDetailsMobileLayoutLoading extends StatefulWidget {
  const ArticleDetailsMobileLayoutLoading({super.key});

  @override
  State<ArticleDetailsMobileLayoutLoading> createState() =>
      _ArticleDetailsMobileLayoutLoadingState();
}

class _ArticleDetailsMobileLayoutLoadingState
    extends State<ArticleDetailsMobileLayoutLoading>
              ...
              child: Column(
                children: [
                  ...
                  Padding(
                    ...
                    child: ArticleMobileHeroLoading(),
                  ),
                ],
              ),
            ),
                ...
                child: Column(
                  children: [
                    Padding(
                      ...
                      child: const ArticleMainContentLoading(),
                    ),
                ...
                child: Column(
                  children: [
                    Padding(
                      ...
                      child: const ArticleSideContentLoading(),
                    ),
                    const CustomFooterVertical(),
                  ],
                ),
