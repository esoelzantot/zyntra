...
class ArticleDetailsTabletLayoutLoading extends StatefulWidget {
  const ArticleDetailsTabletLayoutLoading({super.key});

  @override
  State<ArticleDetailsTabletLayoutLoading> createState() =>
      _ArticleDetailsTabletLayoutLoadingState();
}

class _ArticleDetailsTabletLayoutLoadingState
    extends State<ArticleDetailsTabletLayoutLoading>
