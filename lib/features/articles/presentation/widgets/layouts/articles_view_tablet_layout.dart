...
class ArticlesViewTabletLayout extends StatefulWidget {
  const ArticlesViewTabletLayout({super.key});

  @override
  State<ArticlesViewTabletLayout> createState() =>
      _ArticlesViewTabletLayoutState();
}

class _ArticlesViewTabletLayoutState extends State<ArticlesViewTabletLayout> {
