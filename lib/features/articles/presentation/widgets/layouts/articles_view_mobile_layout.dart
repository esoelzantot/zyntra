...
class ArticlesViewMobileLayout extends StatefulWidget {
  const ArticlesViewMobileLayout({super.key});

  @override
  State<ArticlesViewMobileLayout> createState() =>
      _ArticlesViewMobileLayoutState();
}
