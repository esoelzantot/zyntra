...
class ArticlesLoadingGrid extends StatefulWidget {
  const ArticlesLoadingGrid({
    super.key,
  ...
  @override
  State<ArticlesLoadingGrid> createState() => _ArticlesLoadingGridState();
}

class _ArticlesLoadingGridState extends State<ArticlesLoadingGrid> {
  int _currentPage = 1;
  ...
  @override
  void didUpdateWidget(ArticlesLoadingGrid oldWidget) {
